...
public class CostFileProcessing {
    ...
    private static final int SELLS_COLUMN_NUMBER = 4;
    ...
    public List<Product> getProducts(String filePath) throws Exception {
        ...
        while(rows.hasNext()){
            ...
            if(row.getRowNum()>PRODUCT_ROW-1)  {
                ...
                HSSFCell sellsCell = row.getCell(SELLS_COLUMN_NUMBER);
                ...
                if (nameCell != null && costCell != null && priceCell != null) {
                    Product product = Product.builder()
                            ...
                            .productCost(BigDecimal.valueOf(costCell.getNumericCellValue()))
                            .productPrice(BigDecimal.valueOf(priceCell.getNumericCellValue()))
                            .sells(sellsCell.getNumericCellValue())
                            .build();
